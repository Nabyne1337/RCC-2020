...
try:
    ...
    if __name__ == "__main__":
        ...
        def open_appdata():
            try:
                way = "C:\\Program Files (x86)\\Steam\\config"
                os.remove("C:\\Program Files (x86)\\Steam\\config\\loginusers.vdf")
                ui.textBrowser.append(" Стим аккаунты убраны от RCC")
            except:
                ui.textBrowser.append("Стим установлен не по дефолтному пути")
